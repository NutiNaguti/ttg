...
class chat final : public Object {
 public:
  ...
  chat(int53 id_, object_ptr<ChatType> &&type_, string const &title_, object_ptr<chatPhotoInfo> &&photo_, object_ptr<chatPermissions> &&permissions_, object_ptr<message> &&last_message_, array<object_ptr<chatPosition>> &&positions_, object_ptr<MessageSender> &&message_sender_id_, bool has_protected_content_, bool is_translatable_, bool is_marked_as_unread_, bool is_blocked_, bool has_scheduled_messages_, bool can_be_deleted_only_for_self_, bool can_be_deleted_for_all_users_, bool can_be_reported_, bool default_disable_notification_, int32 unread_count_, int53 last_read_inbox_message_id_, int53 last_read_outbox_message_id_, int32 unread_mention_count_, int32 unread_reaction_count_, object_ptr<chatNotificationSettings> &&notification_settings_, object_ptr<ChatAvailableReactions> &&available_reactions_, int32 message_auto_delete_time_, string const &theme_name_, object_ptr<ChatActionBar> &&action_bar_, object_ptr<videoChat> &&video_chat_, object_ptr<chatJoinRequestsInfo> &&pending_join_requests_, int53 reply_markup_message_id_, object_ptr<draftMessage> &&draft_message_, string const &client_data_);

  static const std::int32_t ID = 422283746;
  std::int32_t get_id() const final {
    return ID;
  }
...
class emojiCategory final : public Object {
 public:
  ...
  emojiCategory(string const &name_, int64 icon_custom_emoji_id_, array<string> &&emojis_);

  static const std::int32_t ID = -1127720750;
  std::int32_t get_id() const final {
    return ID;
  }
...
class inputMessagePhoto final : public InputMessageContent {
 public:
  ...
  inputMessagePhoto(object_ptr<InputFile> &&photo_, object_ptr<inputThumbnail> &&thumbnail_, array<int32> &&added_sticker_file_ids_, int32 width_, int32 height_, object_ptr<formattedText> &&caption_, int32 self_destruct_time_, bool has_spoiler_);

  static const std::int32_t ID = 1658132071;
  std::int32_t get_id() const final {
    return ID;
  }
...
class inputMessageVideo final : public InputMessageContent {
 public:
  ...
  inputMessageVideo(object_ptr<InputFile> &&video_, object_ptr<inputThumbnail> &&thumbnail_, array<int32> &&added_sticker_file_ids_, int32 duration_, int32 width_, int32 height_, bool supports_streaming_, object_ptr<formattedText> &&caption_, int32 self_destruct_time_, bool has_spoiler_);

  static const std::int32_t ID = -1699308024;
  std::int32_t get_id() const final {
    return ID;
  }
...
class messageBotWriteAccessAllowed final : public MessageContent {
 public:
  ...
  static const std::int32_t ID = 1618953309;
  std::int32_t get_id() const final {
    return ID;
  }
